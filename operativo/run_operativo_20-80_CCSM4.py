...
from funciones_extra import get_date_for_weekday, parse_config, parse_date, str_to_bool
...
fecha_d = get_date_for_weekday(start_date=miercoles, target_weekday=Day.SUNDAY)  # --> domingo.
