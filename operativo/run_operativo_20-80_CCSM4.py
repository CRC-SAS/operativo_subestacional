...
# CCSM4 tiene fecha de publicacion el domingo, asi que se busca el domingo previo.
miercoles = dt.datetime.strptime(fecha, '%Y%m%d')
fecha_d = miercoles - dt.timedelta(days=3) #--> domingo. 

tipo='forecast'; conj='RSMAS'; modelo='CCSM4'
