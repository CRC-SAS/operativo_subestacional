...
if __name__ == '__main__':
    ...
    # Definir carpetas con datos y figuras
    carpeta_datos = os.fspath(Path(config.carpeta_datos))
    carpeta_figuras = os.fspath(Path(config.carpeta_figuras))

    #
    # INICIAR CHECKEO
    #

    d0 = xr.open_dataset(f'{carpeta_datos}/operativo/forecast/tas/202501220000/tas_GEFSv12_CPC_202501220000_forecast.nc').tas
    print(d0)
    ...
    ds = xr.open_dataset(f'{carpeta_datos}/2025_diario.nc')
    t2m = ds.t2m
    ...
    ds0 = xr.open_dataset(f'{carpeta_datos}/clim/tmean/tmean_weeklymean_pctile80_smooth.nc').tmean
    ds1 = xr.open_dataset(f'{carpeta_datos}/clim/tmean/tmean_2weeklymean_pctile80_smooth.nc').tmean


    c_out = f'{carpeta_figuras}/operativo/tas/202501220000/'
