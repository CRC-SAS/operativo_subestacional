...
if __name__ == '__main__':
    ...
    # Definir carpetas con figuras
    carpeta_figuras = os.fspath(Path(config.carpeta_figuras).parent)

    #
    # INICIAR GENERACIÓN DE COLORBAR
    #
    ...
    plt.savefig(f'{carpeta_figuras}/colorbar2_vertical_new.jpg', bbox_inches='tight')
    plt.close(fig)
    ...
    plt.savefig(f'{carpeta_figuras}/colorbar2_horizontal_new.jpg', bbox_inches='tight')
    plt.close(fig)
